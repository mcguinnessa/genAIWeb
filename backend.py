...
#
############################################################
   def send_query(self, model, provider, prompt, session_id, workspace_id, temperature, topp, max_tokens):
      ...
      return self.send_query_impl(model, provider, prompt, session_id, workspace_id, temperature, topp, max_tokens)
